...
import RetellWebAgentHero from "./RetellWebAgentHero";

const HeroSection = () => {
  return (
    <section className="relative pt-16 pb-12 md:pb-16 lg:pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl py-8 md:py-12 lg:py-16">
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 md:gap-12 lg:gap-16 xl:gap-20 items-start">
          ...
          {/* Right Side - Enhanced Web Agent with Proper Alignment */}
          <div className="relative flex items-start justify-center pt-0 min-h-[220px] xs:min-h-[275px] sm:min-h-[330px] md:min-h-[385px] lg:min-h-[440px] xl:min-h-[495px]">
            {/* Background Glow */}
            <div className="absolute inset-0 bg-gradient-to-r from-accent/30 via-blue-500/10 to-purple-500/20 blur-3xl"></div>

            {/* RetellWebAgentHero Component */}
            <RetellWebAgentHero />
          </div>
        </div>
      </div>
