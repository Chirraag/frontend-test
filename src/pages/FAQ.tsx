...
const FAQItem: React.FC<FAQItemProps> = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-white/10 last:border-b-0">
      ...
      >
        <div className="pb-6 text-white/80 leading-relaxed">{answer}</div>
      </motion.div>
    </div>
  );
};
  ...
  const aboutKayseTech = [
    {
      ...
      answer: (
        <div>
          <p className="mb-4">
            Kayse is an AI-powered client retention platform specifically built
            for high-volume law firms. Key features include:
          </p>
          ...
          <p>
            ...
            to see Kayse in action for your practice area.
          </p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <p className="mb-4">
            Our Voice AI is designed for natural, human-like conversations:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4">
            <li>
              86% of callers cannot distinguish from human staff in blind tests
            </li>
    ...
    },
    {
      ...
      answer: (
        <div>
          <p className="mb-4">
            Yes, Kayse's AI is specifically trained for legal contexts:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4">
      ...
      answer: (
        <div>
          ...
          <p>
            ...
            about worry-free implementation.
          </p>
        </div>
      ),
    },
      ...
      answer: (
        <div>
          ...
          <p>
            ...
            tailored to your firm size and practice area.
          </p>
        </div>
      ),
    },
  ...
  const clientExperience = [
    {
      ...
      answer: (
        <div>
          <p className="mb-4">
            Actually, clients report more personalized service:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
              {allFAQs.map((category, categoryIndex) => (
                ...
                >
                  <h2 className="text-3xl font-semibold mb-8 tracking-[-0.03em] text-white">
                    {category.category}
                  </h2>
                  <div
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-white/80 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
                  Join 500+ law firms using Kayse to revolutionize their client
                  retention
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    sublabel: "Average across all practice areas",
                  },
                  {
                    stat: "2-3 Months",
                    label: "Time to Full ROI",
                    sublabel: "Most firms see positive returns quickly",
                  },
                  {
                    stat: "24/7/365",
                    label: "Client Support Coverage",
                    sublabel: "Never miss another opportunity",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-white/70 mb-6">
                      Most firms are fully operational within 30 days, with
